    ...
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-950 text-slate-50">
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-10 px-6 py-12">
              ...
              {user ? (
                <>
                  ...
                  <form action={signOutAction}>
                    <button className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:shadow">
                      Выйти
                    </button>
                  </form>
                </>
                ...
                <Link
                  href="/login"
                  className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:shadow"
                >
                  Войти
                </Link>
              )}
        ...
        {user ? (
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <section className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full bg-white/10 px-3 py-1 text-xs text-slate-200">{jobs.length} item(s)</span>
              </div>
                      ...
                      <div className="flex w-full flex-col gap-2">
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="rounded-full bg-emerald-400/10 px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-emerald-200">
                          ...
                          <form action={deleteJobAction}>
                            ...
                            <button
                              type="submit"
                              className="rounded-md w-fit border border-white/20 px-2 py-1 text-xs text-rose-200 transition hover:border-rose-200 hover:text-rose-100"
                            >
                              Delete
                            </button>
                          </form>
                        ...
                        <details className="mt-2 rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-slate-100">
                          ...
                          <form action={updateJobAction} className="mt-3 flex flex-col gap-2">
                            ...
                            <button
                              type="submit"
                              className="mt-1 self-start rounded-md bg-white px-3 py-1 text-xs font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:shadow"
                            >
                              Save changes
                            </button>
                          </form>
            ...
            <section className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              ...
              <form action={createJobAction} className="mt-4 flex flex-col gap-3">
                ...
                <button
                  type="submit"
                  className="mt-2 rounded-lg bg-white px-4 py-2 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:shadow-lg"
                >
                  Save
                </button>
              </form>
          ...
          <div className="flex flex-col items-start gap-4 rounded-3xl border border-dashed border-white/20 bg-white/5 p-8 text-slate-100 backdrop-blur">
            <h2 className="text-2xl font-semibold">Войдите, чтобы работать с воронкой вакансий</h2>
            <p className="max-w-2xl text-slate-200">
              Авторизация, сессии и создание вакансий обрабатываются на сервере Next.js. Этот экран можно расширить таблицами, фильтрами и аналитикой.
            </p>
            <Link
              href="/login"
